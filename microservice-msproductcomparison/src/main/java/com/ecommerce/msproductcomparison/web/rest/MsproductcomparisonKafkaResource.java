...
@RestController
@RequestMapping("/api/msproductcomparison-kafka")
public class MsproductcomparisonKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsproductcomparisonKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsproductcomparisonKafkaResource(KafkaProperties kafkaProperties) {
