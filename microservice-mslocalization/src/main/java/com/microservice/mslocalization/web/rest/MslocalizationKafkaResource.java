...
@RestController
@RequestMapping("/api/mslocalization-kafka")
public class MslocalizationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MslocalizationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MslocalizationKafkaResource(KafkaProperties kafkaProperties) {
