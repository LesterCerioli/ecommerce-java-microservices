...
@RestController
@RequestMapping("/api/msnotifications-kafka")
public class MsnotificationsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsnotificationsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsnotificationsKafkaResource(KafkaProperties kafkaProperties) {
