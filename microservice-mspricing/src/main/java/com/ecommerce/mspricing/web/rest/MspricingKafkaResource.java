...
@RestController
@RequestMapping("/api/mspricing-kafka")
public class MspricingKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspricingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspricingKafkaResource(KafkaProperties kafkaProperties) {
