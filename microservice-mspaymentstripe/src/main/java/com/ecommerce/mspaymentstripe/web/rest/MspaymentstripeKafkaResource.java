...
@RestController
@RequestMapping("/api/mspaymentstripe-kafka")
public class MspaymentstripeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentstripeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentstripeKafkaResource(KafkaProperties kafkaProperties) {
