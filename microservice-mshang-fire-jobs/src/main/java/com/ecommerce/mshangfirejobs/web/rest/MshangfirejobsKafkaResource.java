...
@RestController
@RequestMapping("/api/mshangfirejobs-kafka")
public class MshangfirejobsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MshangfirejobsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MshangfirejobsKafkaResource(KafkaProperties kafkaProperties) {
