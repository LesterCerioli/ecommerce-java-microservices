...
@RestController
@RequestMapping("/api/mspaymentcashfree-kafka")
public class MspaymentcashfreeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentcashfreeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentcashfreeKafkaResource(KafkaProperties kafkaProperties) {
