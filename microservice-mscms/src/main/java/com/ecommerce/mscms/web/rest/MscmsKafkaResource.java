...
@RestController
@RequestMapping("/api/mscms-kafka")
public class MscmsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MscmsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MscmsKafkaResource(KafkaProperties kafkaProperties) {
