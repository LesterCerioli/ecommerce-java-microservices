...
@RestController
@RequestMapping("/api/msactivitylog-kafka")
public class MsactivitylogKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsactivitylogKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsactivitylogKafkaResource(KafkaProperties kafkaProperties) {
