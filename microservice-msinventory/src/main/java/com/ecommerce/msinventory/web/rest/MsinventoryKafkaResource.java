...
@RestController
@RequestMapping("/api/msinventory-kafka")
public class MsinventoryKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsinventoryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsinventoryKafkaResource(KafkaProperties kafkaProperties) {
