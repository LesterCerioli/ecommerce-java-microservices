...
@RestController
@RequestMapping("/api/msorders-kafka")
public class MsordersKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsordersKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsordersKafkaResource(KafkaProperties kafkaProperties) {
