...
@RestController
@RequestMapping("/api/mspaymentmomo-kafka")
public class MspaymentmomoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentmomoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentmomoKafkaResource(KafkaProperties kafkaProperties) {
