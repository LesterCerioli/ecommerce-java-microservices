...
@RestController
@RequestMapping("/api/mscontacts-kafka")
public class MscontactsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MscontactsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MscontactsKafkaResource(KafkaProperties kafkaProperties) {
