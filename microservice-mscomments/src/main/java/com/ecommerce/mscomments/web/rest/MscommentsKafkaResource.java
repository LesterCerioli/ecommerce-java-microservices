...
@RestController
@RequestMapping("/api/mscomments-kafka")
public class MscommentsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MscommentsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MscommentsKafkaResource(KafkaProperties kafkaProperties) {
