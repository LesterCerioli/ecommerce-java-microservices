...
@RestController
@RequestMapping("/api/mspayment-ngan-luong-kafka")
public class MspaymentNganLuongKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentNganLuongKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentNganLuongKafkaResource(KafkaProperties kafkaProperties) {
