...
@RestController
@RequestMapping("/api/mspaymentbraintree-kafka")
public class MspaymentbraintreeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentbraintreeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentbraintreeKafkaResource(KafkaProperties kafkaProperties) {
