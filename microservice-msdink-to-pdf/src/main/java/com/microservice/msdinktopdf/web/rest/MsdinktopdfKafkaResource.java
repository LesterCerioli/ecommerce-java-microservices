...
@RestController
@RequestMapping("/api/msdinktopdf-kafka")
public class MsdinktopdfKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsdinktopdfKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsdinktopdfKafkaResource(KafkaProperties kafkaProperties) {
