...
@RestController
@RequestMapping("/api/mspayments-kafka")
public class MspaymentsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentsKafkaResource(KafkaProperties kafkaProperties) {
