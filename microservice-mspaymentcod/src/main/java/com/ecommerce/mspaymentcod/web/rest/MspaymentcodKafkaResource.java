...
@RestController
@RequestMapping("/api/mspaymentcod-kafka")
public class MspaymentcodKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentcodKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentcodKafkaResource(KafkaProperties kafkaProperties) {
