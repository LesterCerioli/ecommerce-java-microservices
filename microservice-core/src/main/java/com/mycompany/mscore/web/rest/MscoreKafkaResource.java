...
@RestController
@RequestMapping("/api/mscore-kafka")
public class MscoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MscoreKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MscoreKafkaResource(KafkaProperties kafkaProperties) {
