...
@Configuration
@EnableR2dbcRepositories({ "com.ecommerce.mspaymentpaypalexpress.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("com.ecommerce.mspaymentpaypalexpress.repository.search")
