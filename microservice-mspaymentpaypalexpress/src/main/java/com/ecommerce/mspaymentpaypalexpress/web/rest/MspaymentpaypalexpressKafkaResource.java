...
@RestController
@RequestMapping("/api/mspaymentpaypalexpress-kafka")
public class MspaymentpaypalexpressKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MspaymentpaypalexpressKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MspaymentpaypalexpressKafkaResource(KafkaProperties kafkaProperties) {
