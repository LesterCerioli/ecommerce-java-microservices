...
@RestController
@RequestMapping("/api/msnews-kafka")
public class MsnewsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MsnewsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public MsnewsKafkaResource(KafkaProperties kafkaProperties) {
