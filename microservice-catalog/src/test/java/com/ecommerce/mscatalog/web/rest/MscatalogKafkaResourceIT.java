package com.ecommerce.mscatalog.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import com.ecommerce.mscatalog.IntegrationTest;
import com.ecommerce.mscatalog.config.EmbeddedKafka;
import com.ecommerce.mscatalog.config.KafkaSseConsumer;
import com.ecommerce.mscatalog.config.KafkaSseProducer;
...
@WithMockUser
@EmbeddedKafka
class MscatalogKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/mscatalog-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/mscatalog-kafka/consume")
